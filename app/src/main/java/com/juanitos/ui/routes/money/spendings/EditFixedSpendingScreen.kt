    ...
    Scaffold(topBar = {
        ...
        FormColumn(innerPadding) {
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.setDayOfMonthInput(it) },
                label = { Text(text = stringResource(R.string.day_of_month_optional)) },
                isError = !uiState.isDayOfMonthValid,
                singleLine = true,
                modifier = Modifier
                    .fillMaxWidth()
                    .focusRequester(dayOfMonthFocusRequester),
                keyboardOptions = KeyboardOptions(
                    keyboardType = KeyboardType.Number,
                    imeAction = ImeAction.Next
                ),
